...
class dataProcess(object):
	def __init__(self, out_rows, out_cols, train_path="Bladder/train", train_label="Bladder/trainannot",
				 val_path="Bladder/val", val_label="Bladder/valannot",
				 test_path="Bladder/test", test_label='Bladder/testannot', npy_path="./npydata", img_type="png"):
	...
	def create_train_data(self):
		...
		print('loading done')
		np.save(self.npy_path + '/bladder_train.npy', imgdatas)
		np.save(self.npy_path + '/bladder_mask_train.npy', imglabels)
	...
	def create_train_data(self):
		...
		print('loading done')
		np.save(self.npy_path + '/bladder_train_mp.npy', imgdatas)
		np.save(self.npy_path + '/bladder_mask_train_mp.npy', imglabels)
		print('Saving to .npy files done.')
	"""
	...
	def create_test_data(self):
		...
		txtname = './results/bladder.txt'
		with open(txtname, 'w') as f:
			for i in range(len(testpathlist)):
				f.writelines(testpathlist[i] + '\n')
		print('loading done')
		np.save(self.npy_path + '/bladder_test.npy', imgdatas)
	...
	def create_val_test_data(self):
		...
		txtname = './results_val/bladder.txt'
		with open(txtname, 'w') as f:
			for i in range(len(testpathlist)):
				f.writelines(testpathlist[i] + '\n')
		print('loading done')
		np.save(self.npy_path + '/bladder_test_val.npy', imgdatas)
		print('Saving to imgs_test.npy files done.')

	def load_train_data(self):
		print('load train images...')
		imgs_train = np.load(self.npy_path + "/bladder_train.npy").astype('float32') / 255
		print("done loading train, now loading mask")
		imgs_mask_train = np.load(self.npy_path + "/bladder_mask_train.npy").astype('float32') /255
	...
	def load_test_data(self):
		...
		print('-' * 30)
		imgs_test = np.load(self.npy_path + "/bladder_test.npy")
	...
	def load_test_data_val(self):
		...
		print('load test images...')
		print('-' * 30)
		imgs_test = np.load(self.npy_path + "/bladder_test_val.npy")
		imgs_test = imgs_test.astype('float32')
		imgs_test /= 255
		return imgs_test
